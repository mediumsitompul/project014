...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: Scaffold(appBar: AppBar(title: const Center(child: Text('Building Layouts')),),
      body: MyProject(),
      ),
    );
  }
...
class _MyProjectState extends State<MyProject> {
  ...
  Widget build(BuildContext context) {
    ...
    Widget imageSection = Container(
      ...
      child:
      Row( //If Column is not working, must 'Row'
        children: const [
        Expanded(//Keyword
          child:
                Image(image: NetworkImage(
                  'http://192.168.100.100:8087/images/toba.jpg'
                  ),
                ),
        ),
        ],
